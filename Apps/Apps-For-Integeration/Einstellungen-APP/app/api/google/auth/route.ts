...
export async function GET(request: Request) {
  ...
  // the first time. Also re-prompt whenever a newly requested scope (e.g. the
  // learner just checked "Drive" after already connecting Calendar-only)
  // wasn't part of what was previously granted -- otherwise Google silently

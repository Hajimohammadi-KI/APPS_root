...
export const B1_AUTHORED: Readonly<Record<string, AuthoredUnit>> = {
  "Präteritum in Erzählungen": {
    ...
    transfer:
      "Sie öffnete das Fenster und sah die ersten Schneeflocken fallen.",
  },

  Plusquamperfekt: {
    examples: [
      {
        sentence: "Nachdem ich gegessen hatte, ging ich spazieren.",
        target: "hatte",
      },
      ...
      {
        sentence: "Nachdem sie gearbeitet hatte, ruhte sie sich aus.",
        target: "hatte",
      },
      {
        sentence: "Er hatte die Prüfung bestanden, bevor er umzog.",
        target: "hatte",
      },
    ...
    transfer:
      "Nachdem wir das Haus verkauft hatten, zogen wir in eine kleinere Wohnung.",
  },
  ...
  "Relativsätze Nominativ/Akkusativ Vertiefung": {
    examples: [
      ...
      {
        sentence: "Die Frau, die dort steht, ist Ärztin.",
        target: "die dort steht",
      },
      {
        sentence: "Die Frau, die ich kenne, wohnt hier.",
        target: "die ich kenne",
      },
      {
        sentence: "Das Buch, das interessant ist, liegt hier.",
        target: "das interessant ist",
      },
      {
      ...
      {
        sentence: "Der Kollege, der uns unterstützt, ist neu.",
        target: "der uns unterstützt",
      },
      {
        sentence: "Der Kollege, den wir suchen, ist krank.",
        target: "den wir suchen",
      },
    ],
    transfer:
      "Das ist der Kollege, den ich gestern getroffen habe und der mir sehr geholfen hat.",
  },

  "Relativsätze Dativ": {
    examples: [
      {
        sentence: "Die Frau, mit der ich spreche, ist Ärztin.",
        target: "mit der ich spreche",
      },
      {
        sentence: "Der Mann, dem ich helfe, ist mein Nachbar.",
        target: "dem ich helfe",
      },
      {
        sentence: "Das Kind, dem sie vorliest, schläft ein.",
        target: "dem sie vorliest",
      },
      {
        sentence: "Die Kollegen, denen ich vertraue, sind ehrlich.",
        target: "denen ich vertraue",
      },
      {
        sentence: "Der Freund, dem ich schreibe, wohnt in Wien.",
        target: "dem ich schreibe",
      },
      {
        sentence: "Die Freundin, mit der ich rede, versteht mich.",
        target: "mit der ich rede",
      },
      {
        sentence: "Der Chef, dem ich berichte, ist streng.",
        target: "dem ich berichte",
      },
      {
        sentence: "Die Nachbarn, denen ich danke, sind hilfsbereit.",
        target: "denen ich danke",
      },
    ],
    transfer:
      "Das ist die Ärztin, der ich am meisten vertraue, weil sie immer ehrlich ist.",
  },
  ...
  "Konjunktiv II von sein/haben/Modalverben": {
    examples: [
      ...
      {
        sentence: "Wenn ich mehr wüsste, könnte ich besser helfen.",
        target: "könnte",
      },
    ...
    transfer:
      "Wenn ich mehr Zeit hätte, könnte ich jeden Tag eine Stunde lernen.",
  },
  ...
  "Passiv Präsens": {
    ...
    transfer:
      "Das neue Gebäude wird nächstes Jahr gebaut und die Straße wird dann erneuert.",
  },
  ...
  "Passiv Präteritum und Perfekt": {
    ...
    transfer:
      "Das Projekt wurde letztes Jahr begonnen und ist inzwischen abgeschlossen worden.",
  },
  ...
  "Infinitiv mit zu": {
    ...
    transfer:
      "Es ist mir wichtig, jeden Tag zu üben, ohne dabei die Motivation zu verlieren.",
  },

  "um...zu / damit": {
    examples: [
      {
        sentence: "Ich lerne, um die Prüfung zu bestehen.",
        target: "um die Prüfung zu bestehen",
      },
      {
        sentence: "Ich erkläre es, damit du es verstehst.",
        target: "damit du es verstehst",
      },
      {
        sentence: "Sie spart Geld, um ein Auto zu kaufen.",
        target: "um ein Auto zu kaufen",
      },
      {
        sentence: "Er schreibt es auf, damit er es nicht vergisst.",
        target: "damit er es nicht vergisst",
      },
      {
        sentence: "Wir üben täglich, um besser zu werden.",
        target: "um besser zu werden",
      },
      {
        sentence: "Ich rufe an, damit sie Bescheid weiß.",
        target: "damit sie Bescheid weiß",
      },
      {
        sentence: "Sie arbeitet viel, um erfolgreich zu sein.",
        target: "um erfolgreich zu sein",
      },
      {
        sentence: "Er zeigt es mir, damit ich es verstehe.",
        target: "damit ich es verstehe",
      },
    ],
    transfer:
      "Ich schreibe alles auf, damit ich nichts vergesse, und übe täglich, um besser zu werden.",
  },
  ...
  "obwohl/trotzdem": {
    examples: [
      ...
      {
        sentence: "Obwohl er müde war, arbeitete er weiter.",
        target: "Obwohl",
      },
      {
        sentence: "Er war müde; trotzdem arbeitete er weiter.",
        target: "trotzdem",
      },
      {
        sentence: "Obwohl die Prüfung schwer war, bestand sie.",
        target: "Obwohl",
      },
      {
        sentence: "Die Prüfung war schwer; trotzdem bestand sie.",
        target: "trotzdem",
      },
      {
        sentence: "Obwohl wir wenig Zeit hatten, schafften wir es.",
        target: "Obwohl",
      },
      {
        sentence: "Wir hatten wenig Zeit; trotzdem schafften wir es.",
        target: "trotzdem",
      },
    ],
    transfer:
  ...
  Genitivgrundlagen: {
    ...
    transfer:
      "Wegen des schlechten Wetters bleiben wir heute im Haus meiner Eltern.",
  },
  ...
  "Adjektivdeklination Wiederholung und Erweiterung": {
    ...
    transfer:
      "Mit einem guten Lehrer und frischem Mut wird die schwierige Prüfung leichter.",
  },

  "indirekte Fragen": {
    examples: [
      {
        sentence: "Können Sie mir sagen, wann der Kurs beginnt?",
        target: "wann der Kurs beginnt",
      },
      ...
      {
        sentence: "Wissen Sie, wer das gesagt hat?",
        target: "wer das gesagt hat",
      },
      {
        sentence: "Ich frage mich, warum er nicht kommt.",
        target: "warum er nicht kommt",
      },
      {
        sentence: "Können Sie erklären, wie das funktioniert?",
        target: "wie das funktioniert",
      },
  ...
  "Adjektivdeklination vollständig": {
    examples: [
      {
        sentence: "Trotz des kalten Wetters besuchen wir den Markt.",
        target: "kalten",
      },
    ...
    transfer:
      "Trotz des schlechten Wetters besuchen wir den neuen Markt in der ruhigen Altstadt.",
  },
  ...
  Pronominaladverbien: {
    ...
    transfer:
      "Darüber habe ich schon nachgedacht, aber an wen soll ich mich wenden?",
  },
  ...
  "Futur I für Prognosen und Vermutungen": {
    ...
    transfer:
      "Er wird die Prüfung wohl bestehen, denn er hat sehr viel gelernt.",
  },
  ...
  "Vorgangspassiv und Zustandspassiv": {
    examples: [
      ...
      {
        sentence: "Der Brief ist schon geschrieben.",
        target: "ist schon geschrieben",
      },
      { sentence: "Das Zimmer wird aufgeräumt.", target: "wird" },
      { sentence: "Das Zimmer ist aufgeräumt.", target: "ist aufgeräumt" },
    ],
    transfer:
      "Die Tür wird gerade geschlossen, und in ein paar Minuten ist sie geschlossen.",
  },
  ...
  "Temporalsätze mit bevor, nachdem und seitdem": {
    examples: [
      ...
      {
        sentence: "Seitdem sie umgezogen ist, sehen wir uns selten.",
        target: "Seitdem",
      },
      { sentence: "Bevor du fragst, sage ich es dir.", target: "Bevor" },
      { sentence: "Nachdem er angekommen war, rief er an.", target: "Nachdem" },
      {
        sentence: "Seitdem ich hier wohne, fühle ich mich zu Hause.",
        target: "Seitdem",
      },
      { sentence: "Bevor wir starten, prüfen wir alles.", target: "Bevor" },
      {
        sentence: "Nachdem sie gelernt hatte, machte sie eine Pause.",
        target: "Nachdem",
      },
    ],
    transfer:
      "Bevor ich schlafen gehe, lese ich noch, und nachdem ich gelesen habe, bin ich müde.",
  },

  "ohne zu und anstatt zu": {
    examples: [
      {
        sentence: "Er ging, ohne sich zu verabschieden.",
        target: "ohne sich zu verabschieden",
      },
      { sentence: "Sie half, ohne zu zögern.", target: "ohne zu zögern" },
      {
        sentence: "Anstatt zu arbeiten, ruhte er sich aus.",
        target: "Anstatt zu arbeiten",
      },
      {
        sentence: "Er antwortete, ohne nachzudenken.",
        target: "ohne nachzudenken",
      },
      {
        sentence: "Anstatt zu schlafen, lernte sie weiter.",
        target: "Anstatt zu schlafen",
      },
      {
        sentence: "Sie ging weg, ohne etwas zu sagen.",
        target: "ohne etwas zu sagen",
      },
      {
        sentence: "Anstatt zu telefonieren, schrieb er eine E-Mail.",
        target: "Anstatt zu telefonieren",
      },
      {
        sentence: "Er half, ohne gefragt zu werden.",
        target: "ohne gefragt zu werden",
      },
    ],
  ...
  "lassen als Vollverb und Hilfsverb": {
    ...
    transfer:
      "Ich lasse mein Auto reparieren, aber ich lasse den Schlüssel bei dir.",
  },
  ...
  "brauchen nicht zu": {
    ...
    transfer:
      "Du brauchst dir keine Sorgen zu machen, denn wir helfen dir gern.",
  },
  ...
  "Zweiteilige Konnektoren": {
    examples: [
      ...
      {
        sentence: "Sie spricht entweder Deutsch oder Englisch.",
        target: "entweder",
      },
      {
        sentence: "Er hat nicht nur Talent, sondern auch Fleiß.",
        target: "nicht nur",
      },
      { sentence: "Weder er noch sie kam zur Party.", target: "Weder" },
      {
        sentence: "Einerseits will ich reisen, andererseits fehlt das Geld.",
        target: "andererseits",
      },
      {
        sentence: "Sie kauft entweder das rote oder das blaue Kleid.",
        target: "oder",
      },
      {
        sentence: "Er ist nicht nur klug, sondern auch freundlich.",
        target: "sondern auch",
      },
      { sentence: "Weder das Wetter noch die Zeit passten.", target: "noch" },
    ],
    transfer:
      "Einerseits möchte ich den Job annehmen, andererseits bin ich mir noch unsicher.",
  },

  Genitivpräpositionen: {
    examples: [
      {
        sentence: "Wegen des starken Regens blieb ich zu Hause.",
        target: "Wegen des starken Regens",
      },
      {
        sentence: "Trotz des schlechten Wetters gingen wir raus.",
        target: "Trotz des schlechten Wetters",
      },
      {
        sentence: "Während des Kurses war es sehr ruhig.",
        target: "Während des Kurses",
      },
      {
        sentence: "Innerhalb einer Woche war alles fertig.",
        target: "Innerhalb einer Woche",
      },
      {
        sentence: "Wegen der Verspätung verpassten wir den Zug.",
        target: "Wegen der Verspätung",
      },
      {
        sentence: "Trotz der hohen Kosten kauften wir das Haus.",
        target: "Trotz der hohen Kosten",
      },
      {
        sentence: "Während der Prüfung war es still.",
        target: "Während der Prüfung",
      },
      {
        sentence: "Innerhalb des Kurses gab es viele Übungen.",
        target: "Innerhalb des Kurses",
      },
    ],
    transfer:
      "Wegen des starken Windes blieben wir während des ganzen Nachmittags zu Hause.",
  },
};

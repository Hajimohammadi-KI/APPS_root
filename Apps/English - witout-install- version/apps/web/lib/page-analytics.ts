...
export const PAGE_CATALOG = [
	{ route: "/", label: "Home", group: "Practice", routeType: "page" },
	{
		route: "/daily",
	...
	{ route: "/settings", label: "Settings", group: "System", routeType: "page" },
	{
		route: "/teacher",
	...
	{
		route: "/task-lifecycle-monitoring",
		label: "Task Lifecycle Monitoring",
		group: "System",
		routeType: "page",
	},
	{ route: "/support", label: "Support", group: "Utility", routeType: "page" },
	{ route: "/privacy", label: "Privacy", group: "Utility", routeType: "page" },
	{ route: "/offline", label: "Offline", group: "Utility", routeType: "page" },
...
const STORAGE_KEY = "english-automaticity:page-route-attempts:v1";
const SESSION_KEY = "english-automaticity:analytics-session:v1";
const PENDING_KEY = "english-automaticity:pending-route:v1";
const UPDATED_EVENT = "english-automaticity:page-analytics-updated";

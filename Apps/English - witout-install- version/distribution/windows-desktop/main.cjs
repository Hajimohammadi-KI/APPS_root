...
const WEB_PORT = Number(process.env.ENGLISH_GRAMMAR_WEB_PORT || 3202);
const API_PORT = Number(process.env.ENGLISH_GRAMMAR_API_PORT || 4201);
const APP_URL = `http://127.0.0.1:${WEB_PORT}/`;
const APP_ORIGIN = new URL(APP_URL).origin;
const DESKTOP_USER_AGENT_TOKEN = "EnglishGrammarAutomaticityDesktop/27.3.14";

...
} = require("./google-calendar-preload.cjs");
...
const locale = readArgument("desktop-locale", "en");
const darkColor = readArgument("desktop-dark", "#493465");
const highlightColor = readArgument("desktop-highlight", "#7A5AA0");

...
# any non-ASCII characters through the system codepage and corrupts them.
...
# any non-ASCII character before it's even written back out with a correct
# encoding. Force UTF-8 on read.

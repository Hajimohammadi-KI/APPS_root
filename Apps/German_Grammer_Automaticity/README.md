...
- NestJS API
- Supabase Postgres/Auth/Storage foundation for opt-in account synchronization
...
- Full v20.8 catalogs: 79 conversation topics and 84 grammar units
...
`http://localhost:4000/api/v1`, and the exact legacy application at
`http://localhost:3000/klassik`.
...
migration, RLS/RPC layer, private audio bucket, and reproducible 84/79 catalog

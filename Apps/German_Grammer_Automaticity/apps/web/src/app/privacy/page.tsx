    ...
    <main className="mx-auto max-w-5xl px-6 py-10 sm:px-8">
      ...
      <header className="mb-8 rounded-3xl border bg-card p-6 shadow-sm sm:p-8">
        ...
        <p className="mt-3 text-muted-foreground">
          DeutschFlow ist so aufgebaut, dass der vollständige Lernkatalog und die
          meisten Lerndaten auf deinem Gerät bleiben.
        </p>
        <p className="mt-2 text-sm text-muted-foreground">Zuletzt aktualisiert: {updated}</p>
      </header>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <section className="rounded-2xl border bg-card p-5 shadow-sm">
          ...
          <Link className="mt-3 inline-flex text-sm font-medium text-primary hover:underline" href="/support">

    ...
    <main className="mx-auto max-w-5xl px-6 py-10 sm:px-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <section className="rounded-2xl border bg-card p-5 shadow-sm">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Öffne die App nach jedem Update einmal online. Katalog,
            Übungen, Fortschritt und Einstellungen funktionieren lokal.
          </p>
        </section>
        ...
        <section className="rounded-2xl border bg-card p-5 shadow-sm">
          ...
          <Link className="mt-3 inline-flex text-sm font-medium text-primary hover:underline" href="/privacy">

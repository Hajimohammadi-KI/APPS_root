...
// ../../shared/google-calendar-preload.cjs
...
var locale = readArgument("desktop-locale", "de");
var darkColor = readArgument("desktop-dark", "#071B46");
var highlightColor = readArgument("desktop-highlight", "#36D790");
var copy = locale === "de" ? {
  action: "PDF öffnen",
  choosing: "PDF wählen …",
  opened: "Geöffnet",

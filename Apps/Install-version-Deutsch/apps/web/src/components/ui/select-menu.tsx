  ...
  return (
    ...
    >
      <div className={cn("select-menu relative", className)}>
        ...
        <Select.Trigger
          className="select-menu-trigger group flex w-full items-center gap-3 rounded-[14px] border border-select-line bg-select-surface px-3.5 py-2 text-start outline-none transition-[color,border-color,box-shadow,transform] duration-100 ease-[cubic-bezier(0.23,1,0.32,1)] hover:border-select-accent/40 focus-visible:border-select-accent focus-visible:ring-4 focus-visible:ring-select-accent/15 active:scale-[.97] active:duration-150 disabled:cursor-not-allowed disabled:opacity-60"
          id={`${fieldId}-trigger`}
        >

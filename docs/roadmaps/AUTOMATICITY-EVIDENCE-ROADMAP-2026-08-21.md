...
| انتشار عمومی رودمپ | همین HTML به‌صورت artifact محدود و عمومی در GitHub Pages منتشر شد؛ root و دو alias محتوای hash-identical دادند و در viewport تبلت 800×1280 بدون سرریز افقی یا خطای console بودند | [v1.17 PR #48](https://github.com/Hajimohammadi-KI/APPS_root/pull/48)، merge `5673dce` و [Pages deploy 32571214691](https://github.com/Hajimohammadi-KI/APPS_root/actions/runs/32571214691) |

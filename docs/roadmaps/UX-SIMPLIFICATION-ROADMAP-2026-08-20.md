...
## فاز ۱ — ساده‌سازی معماری منو 🟡 (ضرب‌الاجل: فردا ۲۰۲۶-۰۸-۲۱)

**بروزرسانی ۲۰۲۶-۰۸-۲۰ ~۲۳:۲۰:** کاربر ضرب‌الاجل فردا تعیین کرد. بررسی
`git status` نشان داد Codex از قبل (uncommitted) روی فایل‌های ناوبری/Home هر
دو اپ در حال کار است. چک‌لیست دقیق و تقسیم کار برای جلوگیری از تداخل:
...
## فاز ۲ — موتور جلسهٔ روزانهٔ یکپارچه ⬜
